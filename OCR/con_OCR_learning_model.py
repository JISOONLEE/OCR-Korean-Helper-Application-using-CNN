...
HANGUL_FILE = "./Latin_Alphabet_52.txt"
TFRECORDS_DIR = "../data/tfrecords/tfrecord8_latin"
OUTPUT_DIR = "../model/model8"


MODEL_NAME = 'hangul_recognition8'
IMAGE_WIDTH = 64
IMAGE_HEIGHT = 64
#75200 > 73세대 : 55000 > / 65800 > 15세대 : 10000 / 84600 > 15세대: 13,000 > 17세대:15,000 / 47000 > 19세대:9000 / 28200 > 15세대:4500
#latin: 780 > 50세대 : 350
EPOCH = 350
BATCH_SIZE = 100

LOAD_MODEL_STRUCT = "../model/model7/hangul_recognition7.chkp.meta"
LOAD_MODEL_VAL = "../model/model7/hangul_recognition7.chkp"
...
def learn_model(model_struct, model_val, label_file, tfrecords_dir, output_dir, n_epoch):
    ...
    # 학습률, 테스팅률, 시간 기록
    log_file = open("learning_log8.txt", "w")
